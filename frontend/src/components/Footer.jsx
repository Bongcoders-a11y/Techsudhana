      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">FakeNewsDetector</h3>
              <p className="text-gray-400 mb-4">Helping you identify misinformation with AI and community feedback.</p>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} FakeNewsDetector. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
